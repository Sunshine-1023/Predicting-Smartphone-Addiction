...
def row_from_run_dir(
    ...
    *,
    ...
    return {
        ...
        "core_complete_auc": metrics.get("core_complete_auc", ""),
        "core_incomplete_auc": metrics.get("core_incomplete_auc", ""),
        "test_pattern_weighted_auc": metrics.get("test_pattern_weighted_auc", ""),
